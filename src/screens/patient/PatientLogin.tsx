...
import { PatientLoginProps } from '../../navigation/navigation';
...
import { addDoc, collection, getFirestore, query, serverTimestamp, where } from '@react-native-firebase/firestore';
...
const PatientLogin: React.FC<PatientLoginProps> = ({ navigation }) => {
          ...
          (
            <>
              <View style={styles.contentContainer}>
                {!enableRegister && <Text style={styles.title}>Patient Login</Text>}
                {enableRegister && <Text style={styles.title}>Patient Register</Text>}
                <Image
                ...
                <CustomButton onPress={handleRegister} label={'Continue'}></CustomButton>
